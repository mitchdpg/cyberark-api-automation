...
Note: Requires valid CyberArk identity credentials (api user assigned to OAuth app), and a user UUID for lookups (can also do lookups via username). Live execution depends on tenant access.
